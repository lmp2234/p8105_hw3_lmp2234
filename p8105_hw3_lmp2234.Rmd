...
```
#This table shows the age distributions for men and women in each education category. Among individuals between ages 20 and 30 in the "more than high school" catrgory, both males and females had high counts compared to the other age categories. For those in the "high school equivalent" category, the highest count for both males and females was around age 20. In the "less than high school" category", as age increased, the counts for both males and females increased. 
...
activity_plot <- ggplot(activity_long, aes(x = time_point, y = activity_minutes, fill = sex)) +
  geom_area(alpha = 0.5, position = "identity") +  
    geom_smooth(aes(color = sex), method = "loess", se = TRUE, linetype = "solid") + 
