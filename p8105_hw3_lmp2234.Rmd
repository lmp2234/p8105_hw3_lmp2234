...
knitr::kable(education_summary, col.names = c("Education", "Males","Females"), caption = "Education Levels by Sex")
```
...
combined_table<-combined_data  %>%
  ...
  knitr::kable(combined_table, col.names = c("Date", "Casual","Member"), caption = "Number of Citi Bike Members, by Year and Date")
```
